...
| `IEP1001_case3_ragas_evaluation.ipynb` | CASE 3 RAGAS 4지표 전체 평가 · 3종 청킹 비교 · 생존 편향 보정 |
...
**CASE 3 RAGAS 4지표** (judge: `llama3.1:8b`, 506청크, 골든 100개)
...
| **전체** | **0.8537** | **0.6117** | **0.4361** | **0.6143** |

†Phase 2 배포 후 Claude haiku로 재측정 예정 (현재 llama3.1:8b 기준)
